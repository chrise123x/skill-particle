...
class ParticleSkill(MycroftSkill):
    ...
    @intent_handler(IntentBuilder("").require("Water").require("Location"))
    ...
    @intent_handler(IntentBuilder("").require("Daggles"))
    def dork_intent(self, message):
        # In this case, respond by simply speaking a canned response.
        # Mycroft will randomly speak one of the lines from the file
        #    dialogs/en-us/hello.world.dialog
        self.speak_dialog("hello.daggles")
